...
namespace Client
{
    const boost::asio::ip::tcp::endpoint&  create_tcp_endpoint(const std::string& raw_ip, 
    ...
    const boost::asio::ip::udp::endpoint&  create_udp_endpoint(const std::string& raw_ip, 
                                                             const unsigned short port_num)
    {   
        ...
        ep = new boost::asio::ip::udp::endpoint(ip_address, port_num);
